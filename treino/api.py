...
from .shcemas import AlunosSchema,ProgressoAlunoSchema, AulaRealizadaSchema
...
def aula_realizda(request, aula_realizda: AulaRealizadaSchema):
    qtd = aula_realizda.dict()['qtd']
    email_aluno = aula_realizda.dict()['email_aluno']

    if qtd <= 0:
        raise HttpError(400, "Quantidade de aulas deve ser menor que zero")
    ...
    return  200, f"Aula marcada como realizada para o {aluno.nome}"
